...
class CORE_Canvas extends Zend_Controller_Plugin_Abstract
{
    ...
    // dimensões
    public $largura, $altura, $nova_largura, $nova_altura, $tamanho_html;
    // dados do arquivo
    ...
    */
    ...
    /**
     * Redimensiona imagem, cropando para encaixar no novo tamanho, sem sobras, centralizado
     * baseado no script original de Noah Winecoff
     * http://www.findmotive.com/2006/12/13/php-crop-image/
     * atualizado para receber o posicionamento X e Y do crop na imagem
     * @return void
    */
    private function redimensionaCropCentral()
    {
        // calcula posicionamento do crop
        $this->calculaPosicaoCrop();
